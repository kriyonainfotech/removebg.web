...
//                 >
//                     Drop your image and get a transparent background in seconds. 100% free, no signup needed.
//                 </motion.p>
//             </div>
...
//                                     <button
//                                         onClick={removeImage}
//                                         className="absolute -top-4 -right-4 bg-white rounded-full p-2 shadow-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
//                                     >
...
//     ${processing || !processedImage ? 'opacity-50 cursor-not-allowed' : ''}
//   `}
//                                                 onClick={() => {
//                                                     if (processedImage) {
//                                                         // download logic here
...
//                 >
//                     <p>Or drag and drop anywhere on the page</p>
//                     <motion.div
//                         animate={{ y: [0, 5, 0] }}
...
//             >
//                 <div className="absolute top-20 -left-20 w-64 h-64 bg-purple-300  rounded-full filter blur-3xl opacity-20 dark:opacity-10"></div>
//                 <div className="absolute top-40 -right-20 w-72 h-72 bg-pink-300 rounded-full filter blur-3xl opacity-20 dark:opacity-10"></div>
//                 <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-blue-300 rounded-full filter blur-3xl opacity-20 dark:opacity-10"></div>
//             </motion.div>
//         </section>
//     )
// }
